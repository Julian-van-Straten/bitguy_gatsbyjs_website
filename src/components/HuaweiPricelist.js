...
export default () => (
    <div className="tg-wrap">
        <table className="tg" style={{ undefined, tableLayout: `fixed`, width: `100%` }}>
            ...
            <tr>
                <th className="tg-lbcd">Model</th>
                <th className="tg-lbcd">Screen Repair Price</th>
                <th className="tg-qael">Battery Replacement Price</th>
                <th className="tg-qael">Back Cover Replacement Price</th>
            </tr>
            <tr>
            ...
            <tr>
                <td className="tg-dwuk">Huawei Mate 10 Pro</td>
                <td className="tg-dwuk">Contact For Quote</td>
                <td className="tg-dwuk">£50</td>
                <td className="tg-dwuk">£50</td>
            </tr>
